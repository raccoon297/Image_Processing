...
<p align="center">
  <img src="input.jpg" width="760" alt="실내와 실외의 밝기 차이가 큰 원본 영상">
</p>

### 다중 노출 실험

| Under-exposed | Normal-exposed | Over-exposed |
|---|---|---|
| <img src="under.jpg" width="300" alt="저노출 영상"> | <img src="normal.jpg" width="300" alt="정상 노출 영상"> | <img src="over.jpg" width="300" alt="과노출 영상"> |
...
알고리즘의 이론, 코드 분석, 결과 및 추가 고찰은 아래 보고서에 정리되어 있다.

- [`영상신호처리 중간 대체 레포트`](./2021742065_윤동환_영산신호처리_중간대체레포트.pdf)
